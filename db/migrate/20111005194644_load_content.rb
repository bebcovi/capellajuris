  ...
  def up
    ...
    News.create(
      text: "# Nema ipak nastupa\n\n" \
            "Trebali smo nastupati u crkvi sv. Mateja, ali su nam rekli da nas ne žele primiti. Točnije, rekli su: \"Slobodno si vi pjevajte negdje drugdje u nekom podrumčiću, jer nas ne može više boliti briga za vašu glupu Misu Criollu. Zapravo, iskreno, već nam vas je pun kurac.\" Nismo baš sigurni što su mislili pod time...",
      created_at: Date.today)

    # content
    Content.create(
      text: "# Povijest zbora\n\n" \
            '<a href="http://www.flickr.com/photos/67131352@N04/6109212283/" title="povijest_zbora by Janko Marohnić, on Flickr"><img src="http://farm7.static.flickr.com/6076/6109212283_41d11b788a_m.jpg" width="240" height="162" alt="povijest_zbora"></a>' + "\n\n" \
